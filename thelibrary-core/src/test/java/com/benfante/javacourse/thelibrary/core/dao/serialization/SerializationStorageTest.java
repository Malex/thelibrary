...
public class SerializationStorageTest {
	...
	public void testRemoveBook() {
		...
		SerializationStorage lib = new SerializationStorage();
		lib.addBooks(b);
		lib.removeBook(BookUtil.generateBook("4","Sawnremo",new Author(3,"Pippo","Baudo")));
	...
	public void testRemoveBooks() {
		...
		b.add(BookUtil.generateBook("1","Sanremo",new Author(3,"Pippo","Baudo")));
		b.add(BookUtil.generateBook("4","Sawnremo",new Author(3,"Pippo","Baudo")));
		b.add(BookUtil.generateBook("3","Sanremeeeo",new Author(5,"Pippow","Baudow")));
		SerializationStorage lib = new SerializationStorage();
		lib.addBooks(b);
		List<Book> b3 = new LinkedList<>();
		b3.add(BookUtil.generateBook("4","Sawnremo",new Author(3,"Pippo","Baudo")));
		b3.add(BookUtil.generateBook("3","Sanremeeeo",new Author(5,"Pippow","Baudow")));
		lib.removeBooks(b3);
		Collection<Book> b2 = new HashSet<>();
		b2.add(b.get(0));
		assertTrue(b2.equals(lib.books));
	...
	public void testLoadArchive() throws ClassNotFoundException, IOException {
		...
		assertEquals(3,instance.books.size());
